  ...
  const fetchProfile = async () => {
    try {
      ...
      if (data.success) {
        ...
        if (getProfileRouteByRole(userRole) !== '/faculty/profile') {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <Card className="w-full max-w-md">
          ...
          <CardContent>
            <Button onClick={() => router.push('/faculty/dashboard')} className="w-full">
              Go to Dashboard
            </Button>
          </CardContent>
        </Card>
  ...
  return (
    <div className="container mx-auto py-8 px-4 max-w-4xl">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">Manage your faculty information</p>
      </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="flex gap-2 items-center flex-wrap">
                  ...
                  {profile.designation && profile.designation !== 'Not Set' && (
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Your faculty-specific details</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div>
              ...
              <p className="text-base font-medium mt-1 font-mono">
                {profile.facultyId || 'Not Assigned'}
              </p>
            </div>
            <div>
        ...
        <Card className="md:col-span-2">
          <CardHeader>
            ...
            <CardDescription>Your account verification and membership details</CardDescription>
          </CardHeader>
      ...
      <div className="mt-6 flex gap-4 flex-wrap">
        ...
        <Button variant="outline" onClick={() => router.push('/faculty/settings')}>
          Edit Profile
        </Button>
      </div>
    </div>
